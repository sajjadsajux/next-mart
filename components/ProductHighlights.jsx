      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {products.map((product) => (
            <div key={product._id.toString()} className="bg-white rounded-xl shadow-md hover:shadow-lg transition transform hover:-translate-y-1 flex flex-col overflow-hidden">
              {/* Image */}
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                {/* Button */}
                <Link href={`/products/${product._id.toString()}`} className="mt-auto">
                  <button className="w-full px-4 py-2 text-white bg-gradient-to-r from-pink-500 to-violet-500 rounded-xl overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25 focus:outline-none focus:ring-4 focus:ring-purple-300/50">
                    View Details
                  </button>
                </Link>
              </div>
